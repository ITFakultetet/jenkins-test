pipeline {
  ...
  stages {
    ...
    post {
      ...
      failure {
       emailext body: "Dette er en mail fra Jenkins pipeline<br>Jenkins sier<p>: <br><b>Jobb</b>: ${env.JOB_NAME}<br><b>Byggnummer:</b>  ${env.BUILD_NUMBER} mislyktes!", subject: 'Bygging av Jenkins-test feilet', to: 'terje@itfakultetet.no'
